...
content loss is based on higher level features - block5_conv2
style loss is based on lower level features - block1_conv1', 'block2_conv1', 'block3_conv1', 'block4_conv1', 'block5_conv1'
...
def parse_and_set_arguments():
    ...
    parser.add_argument('--style_weight', type=float, default=2.0, required=False, help='Style weight.')
    ...
    # dimensions of the generated picture. Keep aspect ratio of base image
    width, height = load_img(base_image_path).size
    img_nrows = TARGET_WIDTH
...
if __name__ == '__main__':
    ...
    print 'Size of tensor loaded to the model :', input_tensor.shape
